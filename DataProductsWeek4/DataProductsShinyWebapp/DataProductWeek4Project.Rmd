---
title: Developing Data Products course - Assignment Week 4 - Shiny Application and  Reproducible Pitch
...
## Application
 ...
 - The application and the current presentation source codes can be found at <https://github.com/Aysegulzemnos/DataProductsWeek4Project>.
 The application comprises 3 files: *ui.R* (UI), *server.R* (backend) and *modelBuilding_source.R* (Random Forest predictor).
  
## Dataset and Datatableoutput 
