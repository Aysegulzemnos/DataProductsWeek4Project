...
shinyUI(
  ...
  navbarPage(
    ...
    "MPG Prediction and Car types Selection",
    ...
    tabPanel(
      ...
      mainPanel(
        ...
        h3("MPG Prediction and Car types Selection"),
    ...
    tabPanel(
      ...
      h3("Author: Aysegul Sonmez - March 25, 2018"),
      ...
      p("Source code of this application is available at",
        a(href = "https://github.com/Aysegulzemnos/DataProductsWeek4Project",
          "https://github.com/Aysegulzemnos/DataProductsWeek4Project")
      )
